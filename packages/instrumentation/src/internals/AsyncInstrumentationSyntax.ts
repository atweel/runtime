...
interface AsyncInstrumentationSyntax<I extends AsyncInstrumentationLike<I>, R extends object = {}> {
    with<K extends Exclude<keyof I, symbol>>(instrumentation: K, ...parameters: InstrumentationParametersOf<I, K>): AsyncInstrumentationSyntax<I, R & InstrumentationResultOf<I, K>>;
