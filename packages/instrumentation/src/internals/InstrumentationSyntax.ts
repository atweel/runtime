...
interface InstrumentationSyntax<I extends InstrumentationLike<I>, R extends object = {}> {
    with<K extends Exclude<keyof I, symbol>>(instrumentation: K, ...parameters: InstrumentationParametersOf<I, K>): InstrumentationSyntax<I, R & InstrumentationResultOf<I, K>>;
    complete(): R;
}
